      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6">
        {nonBioelectric.length > 0 && (
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-zinc-900 dark:text-white">Light & Temperature</h2>
        ...
        {bioelectric.length > 0 && (
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-zinc-900 dark:text-white">Bioelectric</h2>
