      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6">
        {supplements.length > 0 && (
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-zinc-900 dark:text-white">Supplements</h2>
        ...
        {food.length > 0 && (
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-zinc-900 dark:text-white">Functional Foods</h2>
            <div className="mt-6 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
        ...
        {devices.length > 0 && (
          <section className="mb-12">
            <h2 className="text-2xl font-bold text-zinc-900 dark:text-white">Devices</h2>
            <div className="mt-6 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
